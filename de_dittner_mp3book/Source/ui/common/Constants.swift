...
class Keys {
    let lastPlayedBookID: String = "lastPlayedBookID"
    let demoFileShown: String = "demoFileShown"
    let isManualHidden: String = "isManualHidden"
    let uiTest: String = "uiTest"
}
...
class SizeConstants {
    ...
    init(_ scaleFactor: CGFloat) {
        ...
        playModeTabBarHeight = 60 * scaleFactor
